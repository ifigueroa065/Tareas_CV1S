...
class Cola {
    ...
    subgra(_NodoPadre, _NumPadre) {
        ...
        if (this.first != null) {
            ...
            rank+="N"+_NumPadre+";"
            while (aux != null) {
                nodos += "NN" + (_NumPadre + num.toString()) + "[label=\"" + aux.value + "\"];\n"
...
//Arreglo de numeros
let NUMS =[15,35,68,54,21,85,35,36,32,10,25,35,68,68,9,54,87]
